# Универсальная программа для сети магазинов, которую можно будет использовать для создания различных магазинов.
# Каждый магазин имеет свои особенности, но также общие характеристики (адрес, название и ассортимент товаров.
...
stores = [
    Store("Магазин 1", "Адрес 1"),
    Store("Магазин 2", "Адрес 2")
]
